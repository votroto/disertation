...
\begin{example}\label{ex.zhou19.5.1}
...
u_1(x_1, x_2) =
\frac{
- \sum_{i=1}^{3} \sum_{j=1}^{3} x_{1i}^2 x_{2j}^2 + \sum_{\substack{i=1 \\ i \ne j}}^{3} \sum_{j=1}^{3} (x_{1i} x_{1j} + x_{2i} x_{2j}) 
}{
...
\begin{example}\label{ex.zhou19.5.2.ii}
...
\begin{example}\label{ex.zhou19.5.5.i}
...
\begin{example}\label{ex.zhou19.5.5.ii}
...
\begin{example}\label{ex.zhou19.5.6.i}
...
\begin{example}\label{ex.zhou19.5.6.ii}
...
\begin{example}\label{ex.zhou19.5.7.i}
...
\end{align*}
We also show this game reprojected in polar coordinates in \cref{ex:zhou.5.7.polar}, where we recover the same solution.
\end{example}

\begin{example}\label{ex:zhou.5.7.polar}
...
\end{tikzpicture}
\end{minipage}
\caption{The best-response curves of both players at the $\epsilon$-NE of \cref{ex:zhou.5.7.polar}.}
\label{fig:ex.polar.br}
\end{figure}


\begin{example}\label{ex.zhou19.5.7.ii}
...
\begin{example}\label{ex.zhou19.5.8.i}
...
\begin{example}\label{ex.zhou19.5.9.i}
...
\begin{example}\label{ex.zhou19.5.9.ii}
