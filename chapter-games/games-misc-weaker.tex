...
\begin{example}\label{ex.daskalakis.d}
...
\begin{example}\label{ex.daskalakis.e.1st}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1, 2\},$$
...
\begin{example}\label{ex.mertikopoulos18.fig1}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1,2\}.$$
...
\begin{example}\label{ex.mertikopoulos18.2.2}
A two-player zero-sum game in $1 \times 1$ variables on the interval
...
\begin{example}\label{ex.razaviyayn20.5.1}
...
\begin{example}\label{ex.razaviyayn20.5.3}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
...
\begin{example}\label{ex.zheng23.convex.nonconcave}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
    x_i &\in [-1,1] \quad \forall i \in \{1,2\}
\end{align*}
...
\begin{example}\label{ex.zheng23.kl.nonconcave}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
    x_i &\in [-1,1] \quad \forall i \in \{1,2\}
\end{align*}
...
\begin{example}\label{ex.zheng23.bilinearly.coupled.minimax}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
...
\begin{example}\label{ex.zheng23.forsaken}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
