...
\begin{example}\label{ex.parrilo06.2.1}
...
\begin{example}\label{ex.parrilo06.3.1}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\[
x_i \in [-1,1] \quad \forall i \in \{1,2\}.
\]
...
\begin{example}\label{ex.parrilo06.3.2}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\[
x_i \in [-1,1] \quad \forall i \in \{1,2\}.
\]
...
\begin{example}\label{ex.stein07.4.3.1}
...
\begin{example}\label{ex.stein08.2.3}
A general-sum 2-player game in $1 \times 1$ variables on the interval
\begin{align*}
    x_i &\in [-1,1] \quad \forall i \in \{1,2\}
\end{align*}
...
\begin{example}\label{ex.stein08.2.4}
A general-sum 2-player game in $1 \times 1$ variables on the interval
\begin{align*}
...
\begin{example}\label{ex.stein08.3.10}
