...
\input{chapter-games/games-blotto.tex}

\section{Polynomial Saddle Point Games}
\input{chapter-games/games-nie.tex}
...
\input{chapter-games/games-misc-classical.tex}
\subsection{Experiments on Games with Interesting Weaker Solution Concepts}
\input{chapter-games/games-misc-weaker.tex}
\subsection{Experiments on Games by Parillo, Stein and Ozdaglar}
\input{chapter-games/games-misc-parillo.tex}
\subsection{Experiments on Applied Games and Others}
\input{chapter-games/games-misc-applied.tex}
\subsection{Rational Saddle Point Games}
\input{chapter-games/games-misc-zhou.tex}

\section{Optimization Test Functions}
\input{chapter-games/games-test-functions.tex}

\section{Discontinuous Games with Known Equilibria}
\input{chapter-games/games-bad.tex}
\subsection{Polynomial Saddle Point Games}
\input{chapter-games/games-bad-nie.tex}
\subsection{Rational Saddle Point Games}
\input{chapter-games/games-bad-zhou.tex}
