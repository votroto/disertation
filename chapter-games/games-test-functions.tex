...
\begin{example}\label{ex.adam21.townsend}
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.ackley}
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.boha1}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.branin}
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.mccorm}
A two-player zero-sum game in $1 \times 1$ variables on the intervals
\begin{align*}
    x_1 &\in [-1.5,4] \\
    x_2 &\in [-3,4] 
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.michal}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.surjanovic.rosen}
A two-player zero-sum game in $1 \times 1$ variables on the interval
\begin{align*}
