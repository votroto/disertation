...
\end{equation*}
The Nash equilibrium is $\mu_1^\star = \mathcal{U}_{\{0,1\}}$; $\mu_2^\star = \delta_{0.5}$ and the value is $\frac{1}{4}$.
\end{game}
...
\end{align*}
\textcite[pg. 111]{Dresher2007-ez} proved that the only equilibrium of this game has an infinite support: $\mu_i^\star = \mathcal{U}_{[0,1]}$, and its value is $\frac{1}{6}$.
\end{game}
\end{minipage}
\hfill
