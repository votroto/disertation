...
\begin{example}\label{ex.dresher61.pg110}
...
\begin{example}\label{ex.dresher61.pg111}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1, 2\},$$
...
\begin{example} \label{ex.gross58.poly}
...
\begin{example}\label{ex.karlin59.vol2.sec71.ex1}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1,2\}.$$
...
\noindent
\begin{minipage}[c]{0.6\textwidth}
\begin{example}\label{ex.karlin59.vol2.sec71.ex2}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1,2\}.$$
...
\begin{example}\label{ex.karlin59.vol2.sec76.pr1}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1,2\}.$$
...
\begin{example}\label{ex.karlin59.vol2.sec76.pr2}
A two-player zero-sum game in $1 \times 1$ variables on the interval
$$x_{i1} \in [0,1] \quad \forall i \in \{1,2\}.$$
