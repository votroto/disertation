...
\begin{description}
\item[$\beps$-NE of \ref{ex.golman09.isolated} ($p=1$)] For isolated fronts, DO computed $\epsilon$-NE:
$x_1^\star \approx (1, 0, 0, 0, 0)$, $x_2^\star \approx (1, 0, 0, 0, 0)$
in a single iteration and a time of $0.004\,\mathrm{s}$.
\item[$\beps$-NE of \ref{ex.golman09.pairs} ($p=1$)] For all pairs, DO computed the following $\epsilon$-NE in two iterations and a time of  $0.018\,\mathrm{s}$:
...
\item[$\beps$-NE of \ref{ex.golman09.sets} ($p=1$)] For all sets, DO computed $\epsilon$:
$x_1^\star \approx \left(\frac{1}{5}, \frac{1}{5}, \frac{1}{5}, \frac{1}{5}, \frac{1}{5}\right)$, $x_2^\star \approx \left(\frac{1}{5}, \frac{1}{5}, \frac{1}{5}, \frac{1}{5}, \frac{1}{5}\right)$
