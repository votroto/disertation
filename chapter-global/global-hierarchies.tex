...
\textcite[Section 6.7]{Laurent2009} explains how software such as \emph{GloptiPoly} and \emph{SumOfSquares} extract solutions from a truncated sequence of moments.
{ show how to extract, copy it from masters thesis \color{red} \lipsum[1-3]}
