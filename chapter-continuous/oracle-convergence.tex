...
The Wasserstein distance originated from optimal transport theory. It is nowadays highly instrumental in solving many problems of computer science. Specifically, the \emph{Wasserstein distance} of mixed strategies $\mu,\nu\in \calM(X_i)$ is
\[
