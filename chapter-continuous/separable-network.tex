...
\begin{theorem}\label{thm:opti}
    For every profile of mixed strategies $\bmu^\star \in \bM$ in a zero-sum continuous network game $\calG$, the following are equivalent:
    \begin{enumerate}
