...
\begin{equation}
    \begin{aligned}
        ...
        & w_i - l_{\hat{\by}_{-i}}(u_i) \in Q_{2h}(X_i) &\forall i \in N\\
...
where $l_{\hat{\by}_{-i}}(u_i)$, denotes the polynomial in variables $x_i$, with the rest substituted for the corresponding moments in $\hat{\by}_{-i}$.
